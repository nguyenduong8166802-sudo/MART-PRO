...
async function initDb() {
  await pool.query(`
    ...
    CREATE TABLE IF NOT EXISTS cms_settings (
      ...
      hero_badge TEXT DEFAULT 'V4 FOOD PRO MAX + ZALO',
      hero_title TEXT DEFAULT 'Shopee mini bán đồ ăn + tự báo đơn về Zalo',
      hero_desc TEXT DEFAULT 'Bán hàng thật, giỏ hàng, checkout COD, quản lý đơn, admin CMS, tự báo đơn mới về Zalo.',
      ...
      side_bullets TEXT DEFAULT 'Combo tiết kiệm\nFlash Sale theo giờ\nCOD toàn quốc\nAdmin chỉnh trực tiếp\nTự trừ tồn kho',
  ...
  if (prods.rows[0].n === 0) {
    ...
    await pool.query(`
      ...
      ($1,$6,'Sườn ướp BBQ 500g',169000,149000,25,'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?q=80&w=1000&auto=format&fit=crop','Sườn ướp sẵn đậm vị','Bảo quản ngăn đông',false,true,true),
